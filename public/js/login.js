import { readyToChatting, sendMessage,exitChattingRoom } from './chatting.js';
...
const exitChattingRoomEvent = ()=>{
  exitChattingRoom(27)
}


document.getElementById('exitChattingRoom').addEventListener('click',exitChattingRoomEvent)
